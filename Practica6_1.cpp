...
// No olvides el coste!
//Tiene una llamada a altura_hojas(arbol), por lo que su coste será igual que el de esta función
//Por lo que su coste es O(n), siendo n el número de nodos del árbol de entrada
template <typename T>
...
/*Sea n el número de nodos del árbol de entrada
    T(n) = { k1 n = 0
            { T(ni) + T(nd) + k2 n > 0  Lo cual, como hemos visto en la teoría, tiene coste O(n)

*/
//Primer componente: altura
//Segunda componente: número de hojas de las ramas más largas
template <typename T>
